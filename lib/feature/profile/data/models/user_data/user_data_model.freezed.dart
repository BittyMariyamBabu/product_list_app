...
mixin _$UserDataModel {
 ...
 String get name;@JsonKey(name: 'phone_number') String get phone;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is UserDataModel&&(identical(other.name, name) || other.name == name)&&(identical(other.phone, phone) || other.phone == phone));
}
...
@override
String toString() {
  return 'UserDataModel(name: $name, phone: $phone)';
}
...
@useResult
$Res call({
 String name,@JsonKey(name: 'phone_number') String phone
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String name, @JsonKey(name: 'phone_number')  String phone)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _UserDataModel() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String name, @JsonKey(name: 'phone_number')  String phone)  $default,) {final _that = this;
switch (_that) {
case _UserDataModel():
return $default(_that.name,_that.phone);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String name, @JsonKey(name: 'phone_number')  String phone)?  $default,) {final _that = this;
switch (_that) {
case _UserDataModel() when $default != null:
return $default(_that.name,_that.phone);case _:
  return null;
...
class _UserDataModel implements UserDataModel {
  const _UserDataModel({this.name = '', @JsonKey(name: 'phone_number') this.phone = ''});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _UserDataModel&&(identical(other.name, name) || other.name == name)&&(identical(other.phone, phone) || other.phone == phone));
}
